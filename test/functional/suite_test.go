...
import (
	...
	controllers "github.com/openstack-k8s-operators/heat-operator/internal/controller"
	webhookv1 "github.com/openstack-k8s-operators/heat-operator/internal/webhook/v1beta1"
...
var _ = BeforeSuite(func() {
	...
	err = webhookv1.SetupHeatWebhookWithManager(k8sManager)
	Expect(err).NotTo(HaveOccurred())
